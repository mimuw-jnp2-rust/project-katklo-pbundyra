...
pub fn add_powerups(commands: &mut Commands, world: &[(i32, usize)], game_textures: Res<GameTextures>, rng: &mut ResMut<Random>, level: &Res<Level>) {
...
fn should_add_coffee(x: i32, rng: &mut ResMut<Random>, level: &Res<Level>) -> bool {
    ...
    rng.generator.gen_bool(SPAWNING_COFFEE_PROBABILITY / level.difficulty)
}
...
fn should_add_rust(x: i32, rng: &mut ResMut<Random>, level: &Res<Level>) -> bool {
    ...
    rng.generator.gen_bool(SPAWNING_RUST_PROBABILITY / level.difficulty)
}
