...
use crate::game::{
    camera_follow_player, COFFEE_DURATION, degrade_weapon, FastShootEvent, finish_coffee, FinishLine,
    GameDirection, LastDespawnedEntity, PhantomEntity, RUST_DURATION, ShootEvent, Weapon,
};
use crate::game::bullets::{
    BulletOptions, destroy_bullet_on_contact, kill_enemy, spawn_strong_bullet, spawn_weak_bullet,
};
use crate::game::living_being::{
    LivingBeingDeathEvent, LivingBeingHitEvent, on_living_being_dead, on_living_being_hit,
};
