...
impl MenuTextures {
    pub fn load(asset_server: Res<AssetServer>) -> Self {
        MenuTextures {
            ...
            positive: vec![
                asset_server.load("menu/positive1.png"),
                ...
                asset_server.load("menu/positive7.png"),
                asset_server.load("menu/positive8.png"),
                asset_server.load("menu/positive9.png"),
            ],
            negative: vec![
                asset_server.load("menu/negative1.png"),
