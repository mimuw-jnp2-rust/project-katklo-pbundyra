...
fn setup_main_menu(mut random: ResMut<Random>, commands: Commands,
    ...
    *random = Random::new();
    setup_main(commands, colors, textures, "Mario MIM", vec![("New game", MenuButton::NewGame), ("Quit", MenuButton::Quit)]);
}

fn setup_fail_menu(commands: Commands, colors: Res<MenuColors>, textures: Res<MenuTextures>, level: Res<Level>) {
    setup_level_end(commands, colors, textures, vec![("Try again level", MenuButton::RestartLevel), ("Start from beginning", MenuButton::RestartGame), ("Go to main menu", MenuButton::MainMenu)], Some(false), level.level);
}

fn setup_win_menu(commands: Commands, colors: Res<MenuColors>, textures: Res<MenuTextures>, level: Res<Level>) {
    setup_level_end(commands, colors, textures, vec![("Next level", MenuButton::NextLevel), ("Go to main menu", MenuButton::MainMenu)], Some(true), level.level);
}

fn setup_stop_menu(commands: Commands, colors: Res<MenuColors>, textures: Res<MenuTextures>, level: Res<Level>) {
    setup_level_end(commands, colors, textures, vec![("Restart level", MenuButton::RestartLevel), ("Restart game", MenuButton::RestartGame), ("Go to main menu", MenuButton::MainMenu)], None, level.level);
}
